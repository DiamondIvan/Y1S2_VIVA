...
public class CartList {
    ...
    // Optional: allow Main to provide the undo stack.
    ...
    // Adds at end; if exists, increments quantity.
    // Also reduces stock in inventory via the shared Product reference.
    ...
    // Removes item completely, restoring stock.
    ...
    // Adjust quantity and inventory stock accordingly.
    ...
    // Clears cart WITHOUT restoring stock (use at checkout).
    ...
    // CartList.undo() - this uses the configured undo stack.
    public boolean undo() {
        if (undoStack == null) {
            return false;
        }
    ...
    // Internal removal helper that does NOT change stock (caller already handled
    // stock).
